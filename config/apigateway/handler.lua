...
------------------------------------ Add Header -------------------------------------
    ...
    -- call encode_base64 in nginx
           local b64_string = encode_base64(consumer.username..":"..key)

    -- set header with base64 format
    ngx_set_header("Authorization", "Basic: "..b64_string)
    --ngx_set_header("User-Name", consumer.username)
    --ngx_set_header("Key", key)
------------------------------------ Add Header -------------------------------------
